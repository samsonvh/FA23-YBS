        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GrossTonnageUnit = table.Column<string>(type: "nvarchar(10)", nullable: false),
                    Range = table.Column<int>(type: "int", nullable: false),
                    RangeUnit = table.Column<string>(type: "nvarchar(20)", nullable: false),
                    TotalCrew = table.Column<int>(type: "int", nullable: false),
                    CrusingSpeed = table.Column<int>(type: "int", nullable: false),
                    MaxSpeed = table.Column<int>(type: "int", nullable: false),
                    SpeedUnit = table.Column<string>(type: "nvarchar(20)", nullable: false),
                    ...
                    FuelCapacityUnit = table.Column<string>(type: "nvarchar(10)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VNPayTmnCode = table.Column<string>(type: "varchar(10)", nullable: true),
                    VNPayTxnRef = table.Column<string>(type: "varchar(10)", nullable: true),
                    VNPayResponseCode = table.Column<string>(type: "varchar(10)", nullable: true),
                    VNPAYBankCode = table.Column<string>(type: "varchar(10)", nullable: true),
                    VNPAYcardType = table.Column<string>(type: "varchar(10)", nullable: true),
                    VNPAYTransactionNo = table.Column<string>(type: "varchar(10)", nullable: true),
                    VNPayTransactionStatus = table.Column<string>(type: "varchar(10)", nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
