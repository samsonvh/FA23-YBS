...
namespace YBS.Data.Configs
{
    public class MemberPackageConfig : IEntityTypeConfiguration<MembershipPackage>
    {
        public void Configure(EntityTypeBuilder<MembershipPackage> builder)
        {
            ...
            builder.Property(membershipPackage => membershipPackage.MoneyUnit).HasColumnType("varchar(10)");
            builder.Property(membershipPackage => membershipPackage.Description).HasColumnType("nvarchar(max)").IsRequired(false);
